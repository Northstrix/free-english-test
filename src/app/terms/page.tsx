...
import { TERMS_OF_SERVICE } from '@/lib/policy-text';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="rounded-[var(--radius)] border border-[var(--border-color)] bg-[var(--card-background)] overflow-hidden">
          ...
          <div className="sm:p-[2.25rem_2.2rem] p-[1.6875rem_1.65rem] prose prose-invert max-w-none">
            {renderPolicyContent(TERMS_OF_SERVICE)}
          </div>
        </div>
        <div className={"pt-8 text-[13px] text-[var(--slightly-subtle-foreground)] leading-relaxed text-center w-full"} dir="ltr">
          <div className="mb-1">
            Made by{" "}
            <a
