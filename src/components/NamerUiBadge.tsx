...
export default function NamerUiBadge({
  ...
  const hoverStyle: React.CSSProperties = {
    background: '#111',
    border: '1px solid var(--checkbox-outline-hover)',
  };

  const logoWrapperStyle: React.CSSProperties = isWHiteLogoBackground
    ? {
        width: '32px',
        height: '32px',
        minWidth: '32px',
  ...
  return (
    <>
      <a
        ...
        className={`inline-flex rounded-[var(--radius)] select-none ${className}`}
