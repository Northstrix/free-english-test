...
const RefinedChronicleButton = React.forwardRef<HTMLButtonElement, RefinedChronicleButtonProps>(
  (
    ...
    }), [gapValue, disabled, borderRadius, backgroundColor, textColor, resolvedBorder, resolvedFontSize, fontWeight, buttonHeight, padding, isRTL, width]);
    ...
    }), [hoverBackgroundColor, backgroundColor, hoverTextColor, textColor, resolvedHoverBorderColor]);
